...
- Fork maintenance, upstream `1.5.5` integration, package-layout migration, Pinokio launcher integration, archive import/export, reference glossary import/export, translated-folder glossary templates, Gloss Scan current-manga glossary generation, and Vibe runtime/launcher adaptation: this `BallonsTranslator-vibe` fork
