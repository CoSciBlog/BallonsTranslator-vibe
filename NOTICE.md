...
- Fork maintenance, Pinokio launcher integration, archive import, reference glossary import/export, translated-folder glossary templates, and Gloss Scan current-manga glossary generation: this `BallonsTranslator-vibe` fork
