...
class TwoStepFallbackTest(unittest.TestCase):
    ...
    def test_prompt_separation(self):
        ...
        self.assertIn("NATURAL DIALOGUE AND REFERENCE RULES", normal_prompt)
        self.assertIn("do not copy a character name from every source mention", normal_prompt.lower())
        self.assertIn("natural target-language pronoun or direct address", retry_prompt)
