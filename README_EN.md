...
This fork remains licensed under GPL-3.0. See [LICENSE](LICENSE). The archive importer does not add cloud services or a bundled extractor; CBR support uses the user's local `7z`-compatible tool when available.
