...
class LeftBar(Widget):
    ...
    def __init__(self, mainwindow, *args, **kwargs) -> None:
        ...
        self.runRegionMergeBtn.setIconSize(QSize(17, 17))
        ...
        self.runDecensorBtn.setIconSize(QSize(17, 17))
        ...
        self.runReInpaintBtn.setIconSize(QSize(17, 17))
        ...
        self.runInpaintOptimizeBtn.setIconSize(QSize(17, 17))
        ...
        self.runUpscale2xBtn.setIconSize(QSize(17, 17))
