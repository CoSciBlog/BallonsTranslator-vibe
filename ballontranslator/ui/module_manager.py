...
class ModuleManager(QObject):
    ...
    def on_translatorparam_edited(self, param_key: str, param_content: dict):
        module_name = self.translator_panel.module_combobox.currentText()
        if self.translator is not None and self.translator.name == module_name:
            self.updatePanelParam('translator', self.translator_panel, self.translator, param_key, param_content)
            return
        ModuleManager.updateStoredModuleSetupParam(self, 'translator', module_name, param_key, param_content)
    ...
    def updateStoredModuleSetupParam(self, module_key: str, module_name: str, param_key: str, param_content: dict):
        ...
        ModuleManager.updateParamDictValue(self, module_params, param_key, param_value)
